...
def main():
	...
	parser.add_option('--verbose', action='store_true', help='speak speak speak')
	...
	parser.add_option('--cleanup', action='store_true', help='clean duplicated packages: foo-1.1-YYYYMMDDHHm1 foo-1.1-YYYYMMDDHHm2 are duplicates')
